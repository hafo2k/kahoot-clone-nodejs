...
function addQuestion(){
    ...
    answer1Label.innerHTML = "Đáp án 1: ";
    answer2Label.innerHTML = " Đáp án 2: ";
    answer3Label.innerHTML = "Đáp án 3: ";
    answer4Label.innerHTML = " Đáp án 4: ";
    correctLabel.innerHTML = "Đáp án đúng (1-4): ";
...
function cancelQuiz(){
    if (confirm("Bạn có chắc chắn muốn thoát không? Tất cả câu hỏi đều sẽ bị MẤT!")) {
